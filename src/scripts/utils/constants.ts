...
export enum STORE_KEYS {
  ...
  SKILL_ITEMS_PURCHASED = 'skillItemsPurchased',
  SKILL_ITEMS_USED = 'skillItemsUsed',
}

export enum MAIN_SCENE_STATE {
  INIT = 'INIT',
  STARTED = 'STARTED',
  HIDDEN_CHAR_IN_SCENE = 'HIDDEN_CHAR_IN_SCENE',
  HIDDEN_CHAR_IN_TARGET = 'HIDDEN_CHAR_IN_TARGET',
